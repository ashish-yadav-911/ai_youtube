...
import asyncio # Needed for async engine
...
from app.models import * # Import all your models so Base knows about them
...
async def run_migrations_online() -> None:
    ...
    async with connectable.connect() as connection:
        await connection.run_sync(do_run_migrations) # Run sync migration function
